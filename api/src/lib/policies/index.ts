...
export * as PagePolicy from './pagePolicy/pagePolicy'
export * as PostPolicy from './postPolicy/postPolicy'
export * as CommentPolicy from './commentPolicy/commentPolicy'
export * as TemplatePolicy from './templatePolicy/templatePolicy'
export * as TodoPolicy from './todoPolicy/todoPolicy'
